...
def random_predict(number: int = 1) -> int:
    """Угадываем рандомные числа на основе алгоритм бинарного поиска - применяем
       итерационный метод. Тело цикла повторяеться пока не будет найден элемент, 
       либо если его нет в массиве с помощью которого ищем, возврашает None
    ...
    left = 0
    # Конец границы поиска (т.к.) нам в дальнейшем нужен индекс числа в списке, 
    # то мы отнимаем единицу, т.к. начало индекса 0 (в данной ситуаций 0 - 99(1-100))
